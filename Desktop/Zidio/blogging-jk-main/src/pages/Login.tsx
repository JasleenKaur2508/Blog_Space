...
import { Eye, EyeOff, Mail, Lock, BookOpen, Github, Twitter } from "lucide-react";
...
export default function Login() {
  ...
  const { login, loginWithGoogle, loginWithGitHub, loginWithTwitter, isLoading } = useAuth();
    ...
    try {
      ...
      if (success) {
        ...
        toast({
          ...
          description: "Unable to login with GitHub. Please try again.",
          variant: "destructive",
        });
      }
    } catch (error) {
      toast({
        title: "Error",
        description: "An error occurred during GitHub login.",
        variant: "destructive",
      });
    }
  };
    ...
    try {
      ...
      if (success) {
        ...
        toast({
          ...
          description: "Unable to login with Twitter. Please try again.",
          variant: "destructive",
        });
      }
    } catch (error) {
      toast({
        title: "Error",
        description: "An error occurred during Twitter login.",
        variant: "destructive",
      });
    }
  };
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <div className="flex items-center justify-center mb-4">
              ...
              <span className="font-bold text-2xl gradient-text">BlogSpace</span>
            </div>
        ...
        <div className="max-w-md text-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Connect with writers and readers from around the world. Share your stories, discover new perspectives, and be part of something amazing.
            </p>
          </div>
